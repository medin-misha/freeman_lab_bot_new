...
class BackendClient:
    ...
    def build_file_download_url(self, file_id: int) -> str:
        """Строит backend URL для прямой загрузки файла по его ID."""
    ...
    async def get_telegram_user(self, user_id: int) -> TelegramUserRead:
        """Возвращает Telegram-пользователя backend по внутреннему ID."""

        response_data = await self._request(
            method="GET",
            path=f"/telegram/users/{user_id}",
        )
        return TelegramUserRead.model_validate(response_data)
    ...
    async def get_json(
        ...
        *,
        ...
        """Выполняет GET-запрос и возвращает JSON payload backend."""
    ...
    async def post_json(
        ...
        *,
        ...
        """Выполняет POST-запрос с JSON body и возвращает JSON payload backend."""
    ...
    async def post_multipart(
        ...
        *,
        ...
        """Выполняет multipart/form-data POST-запрос с файлом."""
    ...
    async def _request(
        ...
        *,
        ...
        """Выполняет HTTP-запрос к backend и нормализует базовые ошибки."""
    ...
    async def _parse_response(
        ...
        *,
        ...
        """Преобразует HTTP-ответ в JSON payload или бросает доменную ошибку."""
        ...
        if not isinstance(payload, (dict, list)):
            raise BackendUnexpectedResponseError(
                "Backend JSON payload must be an object or array."
            )
