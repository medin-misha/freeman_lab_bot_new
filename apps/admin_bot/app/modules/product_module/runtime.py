"""Runtime-состояние модуля уведомлений о продуктовых заявках."""
...
async def startup_product_runtime(bot: Bot) -> None:
...
def get_notification_bot() -> Bot:
    ...
    if _notification_bot is None:
        raise RuntimeError("Product notification bot runtime is not initialized.")
