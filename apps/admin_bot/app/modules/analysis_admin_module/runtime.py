"""Runtime-состояние модуля уведомлений о записях на разбор."""
...
async def startup_analysis_admin_runtime(bot: Bot) -> None:
...
async def shutdown_analysis_admin_runtime() -> None:
...
def get_notification_bot() -> Bot:
    ...
    if _notification_bot is None:
        raise RuntimeError("Analysis admin notification bot runtime is not initialized.")
