...
from aio_pika.abc import AbstractIncomingMessage, AbstractQueue, AbstractRobustChannel, AbstractRobustConnection
...
class RMQClient:
    ...
    async def ensure_topology(self, exchange: ExchangeSpec, queue: QueueSpec | None = None) -> AbstractQueue | None:
