...
`telegram` - это прикладной модуль `fastapi_template` для хранения Telegram-пользователей и связанных с ними профилей.
...
`telegram` построен поверх `system` и повторно использует его общие примитивы:
...
Находится в [models/telegram_user.py](/home/misha/code/module_service/fastapi_template/app/modules/telegram/models/telegram_user.py).
...
Находится в [models/user_profile.py](/home/misha/code/module_service/fastapi_template/app/modules/telegram/models/user_profile.py).
...
- [schemas/telegram_user.py](/home/misha/code/module_service/fastapi_template/app/modules/telegram/schemas/telegram_user.py)
- [schemas/user_profile.py](/home/misha/code/module_service/fastapi_template/app/modules/telegram/schemas/user_profile.py)
...
Сервисная логика находится в [services/user_service.py](/home/misha/code/module_service/fastapi_template/app/modules/telegram/services/user_service.py).
...
Router находится в [handlers.py](/home/misha/code/module_service/fastapi_template/app/modules/telegram/handlers.py) и объявлен с префиксом `/telegram`.
...
В [telegram/__init__.py](/home/misha/code/module_service/fastapi_template/app/modules/telegram/__init__.py) наружу экспортируются:
...
```python
from app.modules.telegram import TelegramUser, UserProfile
```
...
- если меняется экспорт, обновляйте `telegram/__init__.py`;
